...
function injectMarathonEnv(entry) {
  return Object.assign({}, entry, pickMarathonEnv(process.env));
}
 ...
 * @param {string} options.uri rabbitmq connection string
 * @param {object} options.connectionOption will be used to pass to broker.Connection
